    ...
    <div className="bg-background text-sm">
      ...
      <nav className="flex flex-col md:flex-row items-center md:justify-between h-10 max-w-[900px] mx-auto px-5 md:px-8 py-1 text-xs">
        ...
        <div className="flex items-center">
          ...
          <Link to="/sign-up">
            <button className="py-2 px-4 border border-primary rounded-md font-bold text-myWhite bg-primary hover:text-primary hover:bg-myWhite">
              Join now
            </button>
          </Link>
        </div>
      ...
      <section className="flex flex-col items-center gap-5 text-center max-w-[900px] my-[80px] mx-auto px-8">
        ...
        <div>
          <button className="border border-primary rounded-md bg-primary w-36 py-2 px-4 mx-3 font-bold text-xs text-myWhite  hover:text-primary hover:bg-myWhite">
            Become a coder
          </button>
          <button className="border border-primary rounded-md bg-myWhite w-36 py-2 px-4 font-bold text-xs text-primary  hover:bg-primary hover:text-myWhite">
            Become a manager
          </button>
        </div>
      </section>
      ...
      <section className="my-[80px] mx-auto px-5 font-semibold">
        <h3 className="text-2xl text-primary font-bold">For coders</h3>
      ...
      <section className="my-[80px] mx-auto px-5 font-semibold">
        <h3 className="text-2xl text-primary font-bold">For managers</h3>
        <p className="text-6xl font-bold py-3">
